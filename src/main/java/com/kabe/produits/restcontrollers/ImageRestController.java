...
import com.kabe.produits.services.ImageService;
...
public class ImageRestController {
    ...
    public void uploadImageFS(@RequestParam("image") MultipartFile
        ...
        Produit p = produitService.convertDtoToEntity(produitService.getProduit(id));
        p.setImagePath(id+".jpg");

        /*Files.write(Paths.get(System.getProperty("user.home")+"/images/"+p.getImagePath())
                , file.getBytes());*/
        Files.write(Paths.get("E:/images/"+p.getImagePath())
                , file.getBytes());
        produitService.saveProduit(produitService.convertEntityToDto(p));
    ...
    public byte[] getImageFS(@PathVariable("id") Long id) throws IOException {
        ...
        Produit p = produitService.convertDtoToEntity(produitService.getProduit(id));
        //return Files.readAllBytes(Paths.get(System.getProperty("E:/")+"/images/"+p.getImagePath()));
        return Files.readAllBytes(Paths.get("E:/images/"+p.getImagePath()));
    }
